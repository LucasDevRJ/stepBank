...
public class ContaCorrente extends Conta {
	...
	public void acessarInformacoesConta(Cliente titular) throws Erro, IOException {
		if (this.isEstaAtiva() == true) {
			...
			System.out.println("Salário: R$ " + titular.getSalario());
	...
	public void transferir(Cliente titular) throws Erro, IOException {
		...
		System.out.println("Digite o número da conta que deseja realzar transferência: ");
		numero = entrada.nextInt();

		System.out.println("Digite a agência que deseja realizar a transferência: ");
		...
		gt.println("Transferência Salva");
		System.out.println();
		gt.close();
		...
		if (this.isEstaAtiva() == false) {
			...
			do {
				...
				if (titular.getNome() != "" && titular.getSobrenome() != "" && titular.getDataNascimento() != ""
					...
					System.err.println("Preencha todas as informações corretamente!!!");
				}
